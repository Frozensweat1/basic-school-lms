...
@php
    ...
    $icons = [
        ...
        'check' => '<svg class="h-4 w-4" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="m3 10 5 5 9-9" stroke-linecap="round" stroke-linejoin="round"/></svg>',
