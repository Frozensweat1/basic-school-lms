...
class Index extends Component
{
    ...
    public function render() { return view('livewire.lms.website.teachers.index',['teachers'=>Teacher::with('user')->where('status','active')->orderBy('website_display_order')->orderBy('last_name')->paginate(15)]); }
}
